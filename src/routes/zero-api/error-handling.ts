...
import type { CreateResponse } from './http'
import type { StatusCodeFn, StatusText } from './statusCode'
...
export const err = {
	handler<E extends (Record<any, any> | null)[]>(...args: E) {
		...
		return <K extends Readonly<StatusCodeFn['Error']>, T extends Parameters<typeof HTTP[K]>[0] = {}, const M = string>(
			response: K,
			payload?: {options?:T,message?:M},
	...
	test<const K extends Record<any, string>>(condition: any, obj: K): Partial<K> | null {
